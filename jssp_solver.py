...
def main():
    ...
    if 'la40' not in instances:
        print("Loading la40 from embedded data...")
        instances['la40'] = JSSPLoader.load_from_string('la40', DATA_LA40)
    
    selected_names = ['ft06', 'la01', 'la29', 'la40']
